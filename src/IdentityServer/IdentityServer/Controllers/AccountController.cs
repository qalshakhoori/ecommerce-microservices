...
namespace IdentityServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var viewModel = await GetLoginViewModelAsync(returnUrl);
        ...
        public async Task<IActionResult> Logout(string logoutId)
        {
            ...
            var vm = await GetLogoutViewModelAsync(logoutId);
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            var vm = await GetLoggedOutViewModelAsync(model.LogoutId);
        ...
        private async Task<LoginViewModel> GetLoginViewModelAsync(string returnUrl)
        {
        ...
        private async Task<LoginViewModel> GetLoginViewModelAsync(LoginInputModel model)
        {
            var vm = await GetLoginViewModelAsync(model.ReturnUrl);
            vm.Username = model.Username;
            vm.RememberLogin = model.RememberLogin;
            return vm;
        }

        private async Task<LogoutViewModel> GetLogoutViewModelAsync(string logoutId)
        {
        ...
        private async Task<LoggedOutViewModel> GetLoggedOutViewModelAsync(string logoutId)
        {
